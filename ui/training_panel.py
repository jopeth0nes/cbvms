...
class TrainingPanel(ctk.CTkFrame):
    ...
    def _build_training_controls(self, right, module: str) -> None:
        ...
        train_btn.grid(row=4, column=0, sticky="ew", pady=(0, PADDING))
        ...
        help_btn.grid(row=5, column=0, sticky="ew")
        ...
        help_box.grid(row=6, column=0, sticky="ew", pady=(4, 0))
    ...
    def _refresh_counts(self, module: str) -> None:
        ...
        if self.trainer.is_trained(module):
    ...
    def _set_buttons_state(self, module: str, enabled: bool) -> None:
        ...
        self._ui[module]["controls"]["train_btn"].configure(state=state)
